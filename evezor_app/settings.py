"""
Django settings for evezor_app project.
...
SECRET_KEY = 'django-insecure-+b_5o$&&!@#gac(c3ok(mi#_7+8*u!+j8fpf@xrug^ga6!&39l'
...
WSGI_APPLICATION = 'evezor_app.wsgi.application'
